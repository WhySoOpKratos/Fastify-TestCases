...
import { FastifyInstance } from '../../../../userService(01)/node_modules/fastify/types/instanceouteOptions, RouteGenericInterface } from './route'
imp../../../../userService(01)/node_modules/fastify/types/route, RawServerDefault, RawRequestDefaultExpression, RawReplyDefaultExpression, ContextConfigDefault } from './utils'
import { Fastif../../../../userService(01)/node_modules/fastify/types/utilsrequest'
import { FastifyReply } f../../../../userService(01)/node_modules/fastify/types/request{ FastifyError } from '@fastify/../../../../userService(01)/node_modules/fastify/types/replytifyBaseLogger } from './logger'../../../../userService(01)/node_modules/@fastify/error/typesstifyTypeProvider,
  FastifyTypeProvi../../../../userService(01)/node_modules/fastify/types/logger/type-provider'
import { RegisterOptions } from './register'
import { F../../../../userService(01)/node_modules/fastify/types/type-providerma'
import { FastifyPluginOptions }../../../../userService(01)/node_modules/fastify/types/register HookHandlerDoneFunction = <TErro../../../../userService(01)/node_modules/fastify/types/schemastifyError>(err?: TError) => void

inter../../../../userService(01)/node_modules/fastify/types/pluginextends Readable {
