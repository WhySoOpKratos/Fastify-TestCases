import { RawReplyDefaultExpression, RawServerBase, RawServerDefault, ContextConfigDefault, RawRequestDefaultExpression, ReplyDefault } from '../../../../userService(01)/node_modules/fastify/types/utilsastifyReplyType, ResolveFastifyReplyType, FastifyTypeProvider, FastifyTypeProviderDefault } from './type-provi../../../../userService(01)/node_modules/fastify/types/type-providert } from './context'
import { Fast../../../../userService(01)/node_modules/fastify/types/context'./logger'
import { FastifyRequest } ../../../../userService(01)/node_modules/fastify/types/loggerort { RouteGenericInterface } from../../../../userService(01)/node_modules/fastify/types/requestastifyInstance } from './instance'
import../../../../userService(01)/node_modules/fastify/types/routefrom './schema'
import { Buffer } f../../../../userService(01)/node_modules/fastify/types/instancenterface ReplyGenericInterface {
../../../../userService(01)/node_modules/fastify/types/schemalt;
}
