...
import { Options as AjvOptions, ValidatorFactory } from '../../../userService(01)/node_modules/@fastify/ajv-compiler/types'
import { FastifyError } from '../../../userService(01)/node_modules/@fastify/error/types'
import { Options as FJSOptions, SerializerFactory } from '../../../userService(01)/node_modules/@fastify/fast-json-stringify-compiler/types'
import { ConstraintStrategy, HTTPVersion } from '../../../userService(01)/node_modules/find-my-way'
import { Chain as LightMyRequestChain, InjectOptions, Response as LightMyRequestResponse, CallbackFunc as LightMyRequestCallback } from '../../../userService(01)/node_modules/light-my-request/types'

import { FastifyBodyParser, FastifyContentTypeParser, AddContentTypeParser, hasContentTypeParser, getDefaultJsonParser, ProtoAction, ConstructorAction } from '../../../userService(01)/node_modules/fastify/types/content-type-parserrt { FastifyContext, FastifyContextConfig } from './type../../../userService(01)/node_modules/fastify/types/contextastifyErrorCodes } from './types/erro../../../userService(01)/node_modules/fastify/types/errorscWithErrOrRes, HookHandlerDoneFunction, RequestPayload, onCloseAsyncHookHandler, onCloseHookHandler, onErrorAsyncHookHandler, onErrorHookHandler, onReadyAsyncHookHandler, onReadyHookHandler, onRegisterHookHandler, onRequestAsyncHookHandler, onRequestHookHandler, onResponseAsyncHookHandler, onResponseHookHandler, onRouteHookHandler, onSendAsyncHookHandler, onSendHookHandler, onTimeoutAsyncHookHandler, onTimeoutHookHandler, preHandlerAsyncHookHandler, preHandlerHookHandler, preParsingAsyncHookHandler, preParsingHookHandler, preSerializationAsyncHookHandler, preSerializationHookHandler, preValidationAsyncHookHandler, preValidationHookHandler, onRequestAbortHookHandler, onRequestAbortAsyncHookHandler } from './types/hooks'
imp../../../userService(01)/node_modules/fastify/types/hooksOptions, FastifyInstance, PrintRoutesOptions } from './types/instance'
import../../../userService(01)/node_modules/fastify/types/instanceFastifyLoggerInstance, FastifyLoggerOptions, PinoLoggerOptions, FastifyLogFn, LogLevel } from './types/logger'
import { Fasti../../../userService(01)/node_modules/fastify/types/loggerstifyPluginAsync, FastifyPluginOptions, FastifyPlugin } from './types/plugin'
import { FastifyRegi../../../userService(01)/node_modules/fastify/types/pluginrOptions, RegisterOptions } from './types/register'
import { FastifyReply } ../../../userService(01)/node_modules/fastify/types/registermport { FastifyRequest, RequestG../../../userService(01)/node_modules/fastify/types/replyrom './types/request'
import { RouteHandler, RouteHandlerMe../../../userService(01)/node_modules/fastify/types/requestouteShorthandMethod, RouteShorthandOptions, RouteShorthandOptionsWithHandler, RouteGenericInterface } from './types/route'
import { FastifySchema, FastifySchemaCompiler../../../userService(01)/node_modules/fastify/types/router, SchemaErrorFormatter } from './types/schema'
import { FastifyServerFactory, FastifyServerFactor../../../userService(01)/node_modules/fastify/types/schemaypes/serverFactory'
import { FastifyTypeProvider, FastifyTypeProvider../../../userService(01)/node_modules/fastify/types/serverFactorye-provider'
import { HTTPMethods, RawServerBase, RawRequestDefaultE../../../userService(01)/node_modules/fastify/types/type-providerxpression, RawServerDefault, ContextConfigDefault, RequestBodyDefault, RequestQuerystringDefault, RequestParamsDefault, RequestHeadersDefault } from './types/utils'

declare module '@fastify/error' {
  interface FastifyError {
    val../../../userService(01)/node_modules/fastify/types/utilsalidationResult[];
